        ...
        <div className=' md:mt-48 sm:mt-32'>
          ...
          <div className='flex ml-2'>
              <div className='text-white flex '>
                 ...
                 <p className='md:text-xs sm:text-[10px] md:mt-2 sm:mt-1 ml-3'>Step 2</p>      
              </div>
          ...
          {/* form */}
          <div className="flex flex-col items-center  md:mt-7 sm:mt-6 "> 
          <input
            type="text"
          ...
          <input
            ...
            className="border border-[#373737] bg-[#222222] sm:text-xs md:text-md rounded-md md:p-2 md:py-2 sm:py-1 mb-3  w-[70%] max-w-[400px] focus:outline-none focus:ring-[0.5px] focus:ring-[#FFCACA] text-white text-center"
          />
